...
<div class="landing">
	<div class="hero">
		...
		<p>
			A simple drawing app for your ideas. Start sketching right away, or create an account to save
			your work and access it from anywhere.
		</p>
	...
	<div class="features">
		<div class="feature">
			...
			<p>
				Shapes, freehand, arrows, text, and more &mdash; everything you need to express your ideas.
			</p>
		</div>
		<div class="feature">
